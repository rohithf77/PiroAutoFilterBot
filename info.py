...
# Bot images & videos
PICS = (environ.get('PICS', 'https://graph.org/file/cf59b94c4eaa5d4e54cdb.jpg')).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1861354020').split()]
