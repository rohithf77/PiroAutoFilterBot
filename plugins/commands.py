    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🤖 𝖩𝗈𝗂𝗇 𝖴𝗉𝖽𝖺𝗍𝖾𝗌 𝖢𝗁𝖺𝗇𝗇𝖾𝗅 🤖", url=f"https://t.me/f7moviesofficial".invite_link
                )
            ]
        ]
        ...
        if message.command[1] != "subscribe" or message.command[1] != "send_all":
            try:
                ...
                btn.append([InlineKeyboardButton("🔄 𝖳𝗋𝗒 𝖠𝗀𝖺𝗂𝗇 🔄", url=f"https://t.me/f7moviesofficial{temp.U_NAME}?start={message.command[1]}")])
    ...
    if data.startswith("all"):
        ...
        for file in files:
            ...
            await client.send_cached_media(
                ...
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ F7 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url=f"https://t.me/f7moviesofficial") ] ] ),
            )
        return
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ MOVIE 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url=f"https://t.me/f7moviesofficial") ] ] ),
    ...
    if not files_:
        ...
        try:
            msg = await client.send_cached_media(
                ...
                file_id=file_id,
                protect_content=True if pre == 'filep' else False,
                reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ MOVIE 𝖴𝖯𝖣𝖠𝖳𝖤𝖲 ⚔️', url="https://t.me/f7moviesofficial") ] ] ),
            )
            filetype = msg.media
