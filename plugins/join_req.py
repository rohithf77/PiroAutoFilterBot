...
@Client.on_message(filters.command('setf') & filters.user(ADMINS))
...
@Client.on_message(filters.command('delf') & filters.user(ADMINS))
...
@Client.on_message(filters.command('viewf') & filters.user(ADMINS))
